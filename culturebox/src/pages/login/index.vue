  ...
  <view class="login-page">
    ...
    <view class="logo-area">
      <view class="logo-icon">
        <text class="logo-text">CB</text>
      </view>
      <text class="app-name">CultureBox</text>
      <text class="app-slogan">记录你的文化足迹</text>
    </view>
    ...
    >
      <view class="privacy-content">
        <text class="privacy-text">
          欢迎您使用 CultureBox！在使用本应用前，请您仔细阅读并理解以下条款：

本应用为个人文化收藏工具。相机权限用于拍摄展览现场照片，存储权限用于上传封面与海报图片，NFC权限用于碰一碰交换书单功能，所有图像数据均在端侧处理，不会上传至服务器。您的账号信息（华为账号ID/手机号）仅用于登录认证与数据同步，我们将采取加密措施保障数据安全。
