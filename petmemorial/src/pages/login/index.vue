<template>
  <view class="login-page">
    ...
    <view class="logo-section">
      ...
      <text class="app-slogan">宠物纪念品定制</text>
    </view>
    ...
    <view class="harmony-login-section">
      <view
        ...
        :class="{ disabled: !userStore.isPrivacyAgreed }"
    ...
    <view class="phone-login-section">
      ...
      <view class="form-item">
        ...
        <view class="code-input-wrap">
          ...
          <text
            class="send-code-btn"
            :class="{ disabled: countdown > 0 || !userStore.isPrivacyAgreed }"
            @click="onSendCode"
    ...
    <view class="agreement-footer">
      ...
      <text class="agreement-link" @click="goWebView('/static/legal/user-agreement.html', '用户协议')">《用户协议》</text>
      <text class="agreement-text">和</text>
      <text class="agreement-link" @click="goWebView('/static/legal/privacy-policy.html', '隐私政策')">《隐私政策》</text>
    </view>
    ...
    >
      <view class="privacy-dialog-content">
        <text class="privacy-dialog-title">欢迎使用 PetMemorial</text>
...
.login-page {
  min-height: 100vh;
  background: linear-gradient(180deg, #F3E8FF 0%, $bg-page 40%);
  display: flex;
