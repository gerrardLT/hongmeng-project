<template>
  <view class="login-page">
    ...
    <view class="logo-section">
      ...
      <text class="app-name">PlantCare</text>
      <text class="app-subtitle">让每一株植物都被温柔以待</text>
    </view>
    ...
    <!-- 跳过登录 -->
    <view class="skip-section" @click="handleSkipLogin">
      <text class="skip-text">跳过登录（本地模式）</text>
    </view>
...
function handleSkipLogin() {
  ...
  userStore.login(localUser, `local_token_${Date.now()}`)
  uni.switchTab({ url: '/pages/index/index' })
}
