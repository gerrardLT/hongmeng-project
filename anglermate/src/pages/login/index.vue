<template>
  <view class="login-page">
    ...
    <view class="logo-section">
      ...
      <text class="app-name">AnglerMate</text>
      <text class="app-subtitle">钓鱼天气钓点记录</text>
    </view>
...
// #ifdef APP-HARMONY
import { loginWithHuawei } from '@/services/auth'
// #endif
...
async function handleHuaweiLogin() {
  ...
  loading.value = true
  try {
    const { userInfo, token } = await loginWithHuawei()
    userStore.setUser(userInfo, token)
