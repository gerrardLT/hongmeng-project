<template>
  <view class="login-page">
    ...
    <view class="logo-section">
      ...
      <text class="app-name">GlassCraft</text>
      <text class="slogan">点亮火焰，塑造独一无二</text>
    </view>

    <!-- 插画区域 - 火焰玻璃图案 -->
    <view class="illustration">
      <view class="flame">
        <view class="flame-layer layer-1"></view>
        <view class="flame-layer layer-2"></view>
        <view class="flame-layer layer-3"></view>
      </view>
      <view class="glass-blob"></view>
    ...
    <Dialog
      ...
      title="隐私政策提示"
      content="欢迎使用 GlassCraft！使用前请阅读并同意《用户协议》和《隐私政策》"
      :show-cancel="true"
      confirm-text="同意并继续"
      cancel-text="不同意"
...
.layer-2 {
  width: 70rpx;
  height: 120rpx;
  background: linear-gradient(to top, $secondary, $secondary-light);
  opacity: 0.85;
  bottom: 10rpx;
}
